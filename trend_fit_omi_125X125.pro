...
;power plant:[112.5738889,35.46555556]
    if ( I eq 325) and (J eq 156) then begin
;	print,'x',x
;	print,'y',y
	print,'B',A[0]
	print,'average[325,156]',average[I,J]
;	print,'C', A[1]
;	print,'E', A[2]
	plot,x,y,psym=2,$
        yrange=[min(y),max(y)],$
	title='fit_0.125X0.125',xtitle='number of months',ytitle='no2/(10^15moles/cm2)'
 	oplot,x,F,psym=0
        image = tvrd(true =1)
        write_jpeg,'no2_fit_0.125x0.125.jpg',image,true=1
   endif
endfor
endfor
...
outfile = '/home/liufei/Data/Satellite/NO2/trend/trend_fit_sci_0.125X0.125.asc'
openw,lun,outfile,/get_lun
printf,lun,header_output,para
close,lun

outfile = '/home/liufei/Data/Satellite/NO2/trend/trend_fit2_sci_0.125X0.125.asc'
openw,lun,outfile,/get_lun
printf,lun,header_output,para2
close,lun

outfile = '/home/liufei/Data/Satellite/NO2/trend/trend_fit3_sci_0.125X0.125.asc'
openw,lun,outfile,/get_lun
printf,lun,header_output,para3
close,lun

outfile = '/home/liufei/Data/Satellite/NO2/trend/trend_fit4_sci_0.125X0.125.asc'
openw,lun,outfile,/get_lun
