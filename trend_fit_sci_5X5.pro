...
;        if nymd eq 20121001 then continue
	...
	header = strarr(6,1)
	filename ='/home/liufei/Data/Satellite/NO2/SCIAMACHY/no2_'+Yr4+Mon2+'_0.5x0.5.asc'
;	filename = '/home/liufei/Data/Satellite/NO2/OMI/no2_'+Yr4+Mon2+'_0.5x0.5.asc'
...
;power plant:[112.5738889,35.46555556]
    if ( I eq 82) and (J eq 40) then begin
;	print,'x',x
;	print,'y',y
	print,'B',A[0]
	print,'average[82,40]',average[I,J]
;	print,'C', A[1]
;	print,'E', A[2]
	plot,x,y,psym=2,$
        yrange=[min(y),max(y)],$
	title='fit_0.5X0.5',xtitle='number of months',ytitle='no2/(10^15moles/cm2)'
 	oplot,x,F,psym=0
        image = tvrd(true =1)
        write_jpeg,'no2_fit_0.5x0.5.jpg',image,true=1
   endif
endfor
endfor
...
header_output = [['ncols 128'],['nrows 80'],['xllcorner 72'],['yllcorner 15'],['cellsize 0.5'],['nodata_value -999.0']]
outfile = '/home/liufei/Data/Satellite/NO2/trend/trend_fit_sci_0.5X0.5.asc'
openw,lun,outfile,/get_lun
printf,lun,header_output,para
close,lun

outfile = '/home/liufei/Data/Satellite/NO2/trend/trend_fit2_sci_0.5X0.5.asc'
openw,lun,outfile,/get_lun
printf,lun,header_output,para2
close,lun

outfile = '/home/liufei/Data/Satellite/NO2/trend/trend_fit3_sci_0.5X0.5.asc'
openw,lun,outfile,/get_lun
printf,lun,header_output,para3
close,lun

outfile = '/home/liufei/Data/Satellite/NO2/trend/trend_fit4_sci_0.5X0.5.asc'
openw,lun,outfile,/get_lun
